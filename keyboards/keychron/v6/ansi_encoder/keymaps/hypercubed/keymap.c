...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [GREEK] = LAYOUT_ansi_109(
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,   _______,    _______,  _______,  _______,  _______,  _______,  _______,  _______,
        _______,  GR_1,     GR_2,     GR_3,     GR_4,     GR_5,     GR_6,    GR_7,      GR_8,     GR_9,     GR_0,     GR_MINS,  GR_EQL,    _______,    _______,  _______,  _______,  _______,  _______,  _______,  _______,
        _______,  GR_Q,     GR_W,     GR_E,     GR_R,     GR_T,     GR_Y,    GR_U,      GR_I,     GR_O,     GR_P,     GR_LBRC,  GR_RBRC,   _______,    _______,  _______,  _______,  _______,  _______,    _______,
