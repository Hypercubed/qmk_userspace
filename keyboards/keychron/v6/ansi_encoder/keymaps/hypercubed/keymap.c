...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_109(
        ...
        KC_LCTL,  KC_LOPTN, KC_LCMMD,                               KC_SPC,                                 MO(GREEK),  MO(SYMBOLS),  MO(WIN_FN), KC_RCTL,    KC_LEFT,  KC_DOWN,  KC_RGHT,  KC_P0,              KC_PDOT,  KC_PENT),
    ...
    [WIN_BASE] = LAYOUT_ansi_109(
        ...
        KC_CAPS,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,              KC_ENT,                                   KC_P4,    KC_P5,    KC_P6,    KC_PPLS,
        KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,              KC_RSFT,              KC_UP,              KC_P1,    KC_P2,    KC_P3,
        KC_LCTL,  KC_LWIN,  KC_LALT,                                KC_SPC,                                 MO(GREEK),  MO(SYMBOLS),  MO(WIN_FN), KC_RCTL,    KC_LEFT,  KC_DOWN,  KC_RGHT,  KC_P0,              KC_PDOT,  KC_PENT),
    ...
    [GREEK] = LAYOUT_ansi_109(
        _______,  _______,  _______,  _______,     _______,  _______,  _______,  _______,     _______,  _______,     _______,  _______,  _______,    _______,    _______,  _______,  _______,  _______,  _______,  _______,  _______,
        _______,  GK_1,     GK_2,     GK_3,        GK_4,     GK_5,     GK_6,     GK_7,        GK_8,     GK_9,        GK_0,     GK_MINS,  GK_EQL,  _______,    _______,  _______,  _______,  _______,  _______,  _______,  _______,
        _______,  GK_THETA, GK_OMEGA, GK_EPSILON,  GK_RHO,   GK_TAU,   GK_PSI,   GK_UPSILON,  GK_IOTA,  GK_OMICRON,  GK_PI,    _______,  _______,    _______,    _______,  _______,  _______,  _______,  _______,  _______,
        _______,  GK_ALPHA, GK_SIGMA, GK_DELTA,    GK_PHI,   GK_GAMMA, GK_ETA,   GK_XI,       GK_KAPPA, GK_LAMBDA,   GK_SCLN,  GK_QUOT,              _______,                                  _______,  _______,  _______,  _______,
        _______,            GK_ZETA,  GK_CHI,      GK_XI,    GK_NU,    GK_BETA,  GK_NU,       GK_MU,    GK_COMM,     GK_DOT,   GK_SLSH,              _______,              _______,            _______,  _______,  _______,
        _______,  _______,  _______,                                _______,                                _______,  _______,  _______,    _______,    _______,  _______,  _______,  _______,            _______,  _______),
    [SYMBOLS] = LAYOUT_ansi_109(
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,    _______,  _______,  _______,  _______,  _______,  _______,  _______,
        _______,  SYM_1,    SYM_2,    SYM_3,    SYM_4,    SYM_5,    SYM_6,    SYM_7,    SYM_8,    SYM_9,    SYM_0,    SYM_MINS,  SYM_EQL,   _______,    _______,  _______,  _______,  _______,  _______,  _______,  _______,
        _______,  SYM_Q,    SYM_W,    SYM_E,    SYM_R,    SYM_T,    SYM_Y,    SYM_U,    SYM_I,    SYM_O,    SYM_P,    SYM_LBRC,  SYM_RBRC,  _______,    _______,  _______,  _______,  _______,  _______,    _______,
